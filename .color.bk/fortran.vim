...
elseif !exists("b:fortran_dialect")
  if exists("g:fortran_dialect") && g:fortran_dialect =~# '\<F\|f90\>'
    " try global variable
...
syn keyword fortranTodo		contained todo fixme XXX NOTE
...
if (b:fortran_fixed_source == 1)
  ...
  " syn match fortranConstant             excludenl "#.*$" contains=fortranTodo
...
hi def link fortranConditional  	Function
" hi def link fortranRepeat       	Repeat
hi def link fortranRepeat       	SpecialChar
...
hi def link fortranBoolean      	SpecialChar
...
hi def link fortranReadWrite	        SpecialChar
" hi def link fortranIO	        	Keyword
hi def link fortranIO	        	SpecialChar
hi def link fortranIntrinsic     	Function
" hi def link fortranConstant	        Constant
hi def link fortranConstant	        Underlined
